# OpenAI Agents SDK documentation map (authoritative links)

Use this file as the **authoritative index** for anything that depends on exact SDK behavior, imports, or API surface. Prefer linking to these pages instead of duplicating docs in the Skill.
...
## Tracing
- [Tracing guide](https://openai.github.io/openai-agents-python/tracing/): Practical tracing usage guide with examples.
- [Tracing API reference](https://openai.github.io/openai-agents-python/ref/tracing/): API documentation for tracing components.
